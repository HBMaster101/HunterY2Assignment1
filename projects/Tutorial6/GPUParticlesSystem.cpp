...
{
	unsigned int vs = Utility::loadShader("../../bin/shaders/particle2.vert", GL_VERTEX_SHADER);
	unsigned int fs = Utility::loadShader("../../bin/shaders/particle2.frag", GL_FRAGMENT_SHADER);
	unsigned int gs = Utility::loadShader("../../bin/shaders/particle2.geom", GL_GEOMETRY_SHADER);
...
void GPUParticleEmitter::createUpdateShader()
{
	...
	unsigned char* source = Utility::fileToBuffer("../../bin/shaders/particle2Update.vert");
